...
class Dots:
    ...
    def __init__(self, WIDTH, HEIGHT, 
        ...
        self.top_row = [Dot(self.SPACING * i, self.TH) for i in range(self.WIDTH/self.SPACING + 1)]
        self.bottom_row = [Dot(self.SPACING * i, self.BH) for i in range(self.WIDTH/self.SPACING + 1)]
        self.left_col = [Dot(self.LV, self.SPACING * i) for i in range(self.HEIGHT/self.SPACING + 1)]
        self.right_col = [Dot(self.RV, self.SPACING * i) for i in range(self.HEIGHT/self.SPACING + 1)]
    ...
    def dots_left(self):
        ...
        return len(self.top_row) + len(self.bottom_row) + len(self.left_col) + len(self.right_col)
