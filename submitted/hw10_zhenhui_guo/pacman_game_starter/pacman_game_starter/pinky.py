...
class Pinky(GameCharacter):
    ...
    def update(self):
        ...
        on_horiz = ((abs(self.y - self.maze.TOP_HORIZ) < self.WALL_TOLERANCE) or
        ...
        # If Pinky gets close to Pacman, tell the GameController that Pinky wins
        if abs(up_down_part) < self.WIN_PROXIMITY and abs(left_right_part) < self.WIN_PROXIMITY:
